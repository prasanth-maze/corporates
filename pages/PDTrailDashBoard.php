  ...
  <div class="page" >
    <div class="page-content container-fluid ">
          ...
          <a href="#ReportTablediv" title="Click to view the sowing data" class="restabs1" data-filter="SOWING" data-tbl="sowingRestbl" data-tab="sowingRes">
            ...
            <div class="card-block p-20 pt-10">
              <div class="clearfix">
                ...
                <span class="float-right grey-700 font-size-20 stage_sowing">0</span>
              </div>
          ...
          <div class="card card-shadow" id="widgetLineareaTwo">
            <div class="card-block p-20 pt-10">
              <div class="clearfix">
                ...
                <span class="float-right grey-700 font-size-20 stage_70_80">0</span>
              </div>
              <div class="mb-20 grey-500">
           ...
           <a href="#ReportTablediv" class="restabs1" title="Click to view the 120-130 days data" data-filter="120-130" data-tbl="120-130Restbl" data-tab="120-130Res"> 
            ...
            <div class="card-block p-20 pt-10">
              <div class="clearfix">
                ...
                <span class="float-right grey-700 font-size-20 stage_120_130">0</span>
              </div>
              <div class="mb-20 grey-500">
           ...
           <div class="card card-shadow" id="widgetLineareaThree">
            <div class="card-block p-20 pt-10">
              <div class="clearfix">
                ...
                <span class="float-right grey-700 font-size-20 stage_picking_yield">0</span>
              </div>
              <div class="mb-20 grey-500">
        ...
        <div class="column-3 col-sm-12">
          ...
          <a href="#ReportTablediv" title="Click to view the closed data" class="restabs1" data-filter="CLOSED" data-tbl="closedResTable"  data-tab="closedRes"> 
            ...
            <div class="card-block p-20 pt-10">
              <div class="clearfix">
                ...
                <span class="float-right grey-700 font-size-20 stage_closed">0</span>
              </div>
              <div class="mb-20 grey-500">
          ...
          <div class="row col-xxl-12" style="margin-left: 3px;margin-bottom: -15px;margin-top: -45px;"> 
      <div class="col-lg-4">
            <div class="panel">
      ...
      <div class="col-lg-4">
       ...
       <div class="row">
        ...
        <div class="col-xxl-12 col-lg-12" id="resultarea" style='display:none;'>
          <!-- Example Heading With Desc -->
          <div class="panel panel-bordered">
            <div class="panel-heading text-center">
              <h3 class="panel-title">List Of Activites</h3>
            </div>
