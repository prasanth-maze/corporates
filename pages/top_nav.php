...
margin-right: -40px;"> --></a> </header>
    ...
    <div class="menu">
      <ul id="menu" >
        <li id="menu-home" class="<?=@($cpage=='EventDashboard')?'active':''?>"><a href="EventDashboard.php"><i class="fa fa-home"></i><span>Event</span></a></li>
        <li id="menu-login" class="<?=@($cpage=='LoginActivityDashboard')?'active':''?>"><a href="LoginActivityDashboard.php"><i class="fa fa-history"></i><span>Login Tracker</span></a></li>
        <li id="menu-reports" class="<?=@($cpage=='Reports')?'active':''?>"><a href="UMReport.php"><i class="fa fa-book fa-fw" aria-hidden="true" ></i><span>Reports</span></a></li>
