...
$cpage = basename($_SERVER['SCRIPT_NAME'],'.php');
  //p($_SESSION);
  $sp = "EXEC EMPAccess @empcode='".$_SESSION['EmpID']."'";
  echo $sp;
?>
            ...
            <div class="panel-body" style="margin-top: -10px">
               ...
               <div class="input-daterange" data-plugin="datepicker" data-date-format="mm-yyyy">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control form-control-sm" id="fromMY" name="from" autocomplete="off" value="10-2019" />
                    </div>
                    <div class="input-group">
                      <span class="input-group-addon">to</span>
                      <input type="text" class="form-control form-control-sm" id="toMY" name="to" autocomplete="off" value="11-2019" />
                    </div>
                  </div>
              <!-- Department -->
