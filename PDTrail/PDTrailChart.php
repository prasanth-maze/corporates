...
//p($_POST,'e');
	...
	$psql = "EXEC PDTrail_KPI @required='".$_POST['required']."',@pdiv='".@$pdiv."',@season='".@$season."',@zcode='".@$ezmcode."',@rbmcode='".@$erbmcode."',@tmcode='".@$etmcode."',@pocode='".@$epocode."',@product='".@$_POST['product']."',@hybrid='".@$_POST['hybrid']."',@activity='".@$_POST['activity']."' ";
	//echo $psql;exit;
