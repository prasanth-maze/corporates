			...
			while($prow = sqlsrv_fetch_array($stmt)){	
				$cspen='yes';
					...
					if(isset($prow['SOWING'])){
						...
						$zmcountarr['SOWING'][] = array("name"=>$zmid."<span style='display:none'>".$zid."</span>","y"=>$zevtcount,"tname"=>$zmid,"NID"=>$zid,"act"=>"SOWING","hc"=>$prow['HYBRIDSCOVERED'],"nt"=>$zevtcount);
				...
				if($cspen=='no'){
					...
					$zmcountarr['SOWING'][] = array("name"=>$zmname."<span style='display:none'>".$ZMID."</span>","y"=>0,"tname"=>$zmname,"NID"=>$ZMID,"act"=>"SOWING","hc"=>0,"nt"=>0);
				}
			...
			if($data['required']=='All' || $data['required']=="" || $data['required']=="STAGE_70_80"){
				...
				$csapp ='yes';	
					...
					if(isset($prow['STAGE_70_80'])){
						...
						$zmcountarr['STAGE_70_80'][] = array("name"=>$zmid."<span style='display:none'>".$zid."</span>","y"=>$zevtcount,"tname"=>$zmid,"NID"=>$zid,"act"=>"STAGE_70_80","hc"=>$prow['HYBRIDSCOVERED'],"nt"=>$zevtcount);
						if(!array_key_exists($zid, $zmidarr)){
				...
				if($csapp=='no'){
					...
					$zmcountarr['STAGE_70_80'][] = array("name"=>$zmname."<span style='display:none'>".$ZMID."</span>","y"=>0,"tname"=>$zmname,"NID"=>$ZMID,"act"=>"STAGE_70_80","hc"=>0,"nt"=>0);
				}
		...
		if($data['required']=='All' || $data['required']=="" || $data['required']=="STAGE_120_130"){
				...
				$csexe = 'yes';		
					...
					if(isset($prow['STAGE_120_130'])){
						...
						$zmcountarr['STAGE_120_130'][] = array("name"=>$zmid."<span style='display:none'>".$zid."</span>","y"=>$zevtcount,"tname"=>$zmid,"NID"=>$zid,"act"=>"STAGE_120_130","hc"=>$prow['HYBRIDSCOVERED'],"nt"=>$zevtcount);
						if(!array_key_exists($zid, $zmidarr)){
							$zmidarr[$zid] = $prow['ZONENAME'];
						}
				...
				if($csexe=='no'){
					...
					$zmcountarr['STAGE_120_130'][] = array("name"=>$zmname."<span style='display:none'>".$ZMID."</span>","y"=>0,"tname"=>$zmname,"NID"=>$ZMID,"act"=>"STAGE_120_130","hc"=>0,"nt"=>0);
				}
			}

			$csexe = 'no';
		if($data['required']=='All' || $data['required']=="" || $data['required']=="STAGE_150_160"){
				while($prow = sqlsrv_fetch_array($stmt)){	
				$csexe = 'yes';		
					$zmid = $prow['ZONENAME'];
					$zid = $prow['ZONEID'];									
					if(isset($prow['STAGE_150_160'])){
						$zevtcount= $prow['STAGE_150_160'];
						$zmcountarr['STAGE_150_160'][] = array("name"=>$zmid."<span style='display:none'>".$zid."</span>","y"=>$zevtcount,"tname"=>$zmid,"NID"=>$zid,"act"=>"STAGE_150_160","hc"=>$prow['HYBRIDSCOVERED'],"nt"=>$zevtcount);
						if(!array_key_exists($zid, $zmidarr)){
							$zmidarr[$zid] = $prow['ZONENAME'];
						}
				...
				if($csexe=='no'){
					...
					$zmcountarr['STAGE_150_160'][] = array("name"=>$zmname."<span style='display:none'>".$ZMID."</span>","y"=>0,"tname"=>$zmname,"NID"=>$ZMID,"act"=>"STAGE_150_160","hc"=>0,"nt"=>0);
				}
			}
		...
		if($data['required']=='All' || $data['required']=="" || $data['required']=="STAGE_PICKING_YIELD"){
				...
				$csexe = 'yes';		
					...
					if(isset($prow['STAGE_PICKING_YIELD'])){
						...
						$zmcountarr['STAGE_PICKING_YIELD'][] = array("name"=>$zmid."<span style='display:none'>".$zid."</span>","y"=>$zevtcount,"tname"=>$zmid,"NID"=>$zid,"act"=>"STAGE_PICKING_YIELD","hc"=>$prow['HYBRIDSCOVERED'],"nt"=>$zevtcount);
						if(!array_key_exists($zid, $zmidarr)){
							$zmidarr[$zid] = $prow['ZONENAME'];
						}
				...
				if($csexe=='no'){
					...
					$zmcountarr['STAGE_PICKING_YIELD'][] = array("name"=>$zmname."<span style='display:none'>".$ZMID."</span>","y"=>0,"tname"=>$zmname,"NID"=>$ZMID,"act"=>"STAGE_PICKING_YIELD","hc"=>0,"nt"=>0);
				}
		...
		if($data['required']=='All' || $data['required']=="" || $data['required']=="STAGE_CLOSED"){
				...
				$csexe = 'yes';		
					...
					if(isset($prow['STAGE_CLOSED'])){
						...
						$zmcountarr['STAGE_CLOSED'][] = array("name"=>$zmid."<span style='display:none'>".$zid."</span>","y"=>$zevtcount,"tname"=>$zmid,"NID"=>$zid,"act"=>"STAGE_CLOSED","hc"=>$prow['HYBRIDSCOVERED'],"nt"=>$zevtcount);
						if(!array_key_exists($zid, $zmidarr)){
							$zmidarr[$zid] = $prow['ZONENAME'];
						}
				...
				if($csexe=='no'){
					...
					$zmcountarr['STAGE_CLOSED'][] = array("name"=>$zmname."<span style='display:none'>".$ZMID."</span>","y"=>0,"tname"=>$zmname,"NID"=>$ZMID,"act"=>"STAGE_CLOSED","hc"=>0,"nt"=>0);
				}
	...
	$psql = "EXEC PDTrail_rbmLocWiseEvt @required='".$data['required']."',@pdiv='".@$data['pdivision']."',@season='".@$data['season']."',@zcode='',@rbmcode='".@$REGIONID."',@product='".@$data['product']."',@hybrid='".@$data['hybrid']."',@activity='".@$data['activity']."'";
			...
			if($data['required']=='All' || $data['required']=="" || $data['required']=="STAGE_150_160"){
				...
				$csapp = 'yes';
				    ...
				    $rid = $prow['REGIONID'];
					if(isset($prow['STAGE_150_160'])){
						$revtcount= $prow['STAGE_150_160'];
						$rdrilldown = $regid.'APP';
						$rbecountarr['STAGE_150_160'][] = array("name"=>$regid."<span style='display:none'>".$rid."</span>","y"=>$revtcount,"tname"=>$regid,"NID"=>$rid,"act"=>"STAGE_150_160");
						if(!array_key_exists($rid, $regidarr)){
					...
					$rbecountarr['STAGE_150_160'][] = array("name"=>$rname."<span style='display:none'>".$REGIONID."</span>","y"=>0,"tname"=>$rname,"NID"=>$REGIONID,"act"=>"STAGE_150_160");
			}
			...
			if($data['required']=='All' || $data['required']=="" || $data['required']=="STAGE_CLOSED"){
				...
				$csexe='yes';
					...
					if(isset($prow['STAGE_CLOSED'])){
						...
						$rbecountarr['STAGE_CLOSED'][] = array("name"=>$regid."<span style='display:none'>".$rid."</span>","y"=>$revtcount,"tname"=>$regid,"NID"=>$rid,"act"=>"STAGE_CLOSED");
						if(!array_key_exists($rid, $regidarr)){
				...
				if($csexe=='no'){
					...
					$rbecountarr['STAGE_CLOSED'][] = array("name"=>$rname."<span style='display:none'>".$REGIONID."</span>","y"=>0,"tname"=>$rname,"NID"=>$REGIONID,"act"=>"STAGE_CLOSED");
			}
				}
			}
			//p($rbecountarr,'e');
		...
		//echo $psql1;exit;
			...
			if($data['required']=='All' || $data['required']=="" || $data['required']=="SOWING"){
				...
				if($data['required']=='All' || $data['required']=="" || $data['required']=="STAGE_150_160"){
					while($prow1 = sqlsrv_fetch_array($stmt1)){	
						...
						$tmid = $prow1['TMNAME'].'';
						$tid = $prow1['TMID'];
						if(isset($prow1['STAGE_150_160'])){
						$tevtcount= $prow1['STAGE_150_160'];
						$alltmcountarr['STAGE_150_160'][] =  array("name"=>$tmid."<span style='display:none'>".$tid."</span>","y"=>$tevtcount,"tname"=>$tmid,"NID"=>$tid,"act"=>"STAGE_150_160");
							if(!array_key_exists($prow1['TMID'], $tmidarr)){
					...
					$alltmcountarr['STAGE_150_160'][] =  array("name"=>$tname."<span style='display:none'>".$TMID."</span>","y"=>0,"tname"=>$tname,"NID"=>$TMID,"act"=>"STAGE_150_160");
					}
			...
			if($data['required']=='All' || $data['required']=="" || $data['required']=="STAGE_CLOSED"){
					while($prow1 = sqlsrv_fetch_array($stmt1)){	
						...
						$alltmcountarr['STAGE_CLOSED'][] =  array("name"=>$tmid."<span style='display:none'>".$tid."</span>","y"=>$tevtcount,"tname"=>$tmid,"NID"=>$tid,"act"=>"STAGE_CLOSED");
						if(!array_key_exists($prow1['TMID'], $tmidarr)){
								$tmidarr[$tid] = $prow1['TMNAME'];
							}
					...
					$alltmcountarr['STAGE_CLOSED'][] =  array("name"=>$tname."<span style='display:none'>".$TMID."</span>","y"=>0,"tname"=>$tname,"NID"=>$TMID,"act"=>"STAGE_CLOSED");
					}
	...
	//echo $psql2;exit;
				...
				if($data['required']=='All' || $data['required']=="" || $data['required']=="STAGE_150_160"){
					while($prow2 = sqlsrv_fetch_array($stmt2)){	
						...
						$poid = $prow2['POHQNAME'];
						$pid = $prow2['POHQCODE'];
						if(isset($prow2['STAGE_150_160'])){
						$poevtcount= $prow2['STAGE_150_160'];
						$allpocountarr['STAGE_150_160'][] =  array("name"=>$poid."<span style='display:none'>".$pid."</span>","y"=>$poevtcount,"tname"=>$poid,"NID"=>$poid,"act"=>"STAGE_150_160");
						$poidarr[$pid] = $poid;
						}
					}
						if($csapp=='no'){
					...
					$allpocountarr['STAGE_150_160'][] =  array("name"=>$poname."<span style='display:none'>".$POCODE."</span>","y"=>0,"tname"=>$poname,"NID"=>$poname,"act"=>"STAGE_150_160");
					}
					sqlsrv_next_result($stmt2);
				}
				...
				if($data['required']=='All' || $data['required']=="" || $data['required']=="STAGE_CLOSED"){
					...
					while($prow2 = sqlsrv_fetch_array($stmt2)){	
						...
						$allpocountarr['STAGE_CLOSED'][] =  array("name"=>$poid."<span style='display:none'>".$pid."</span>","y"=>$poevtcount,"tname"=>$poid,"NID"=>$poid,"act"=>"STAGE_CLOSED");
							$poidarr[$pid] = $poid;
						}
					}
					if($csexe=='no'){
					...
					$allpocountarr['STAGE_CLOSED'][] =  array("name"=>$poname."<span style='display:none'>".$POCODE."</span>","y"=>0,"tname"=>$poname,"NID"=>$poname,"act"=>"STAGE_CLOSED");
					}
				}
	...
	foreach($hyball_code AS $HYBRID){
		...
		if($data['required']=='All' || $data['required']=="" || $data['required']=="STAGE_150_160"){
			while($prow1 = sqlsrv_fetch_array($stmt1)){
				$csapp ='yes';	
				if(isset($prow1['STAGE_150_160'])){
					$ovhcount +=$prow1['STAGE_150_160'];
				$allhybridcountarr['STAGE_150_160'][$ckey] = array("name"=>$prow1['HYBRIDNAME'],'y'=>$prow1['STAGE_150_160'],"tname"=>$prow1['HYBRIDNAME'],"NID"=>$prow1['HYBRIDNAME'],"act"=>"STAGE_150_160");
				}
			}

			if($csapp=='no'){
				$ovhcount +=0;
				$allhybridcountarr['STAGE_150_160'][$ckey] = array("name"=>$HYBRID,'y'=>0,"tname"=>$HYBRID,"NID"=>$HYBRID,"act"=>"STAGE_150_160");
				}
	...
	foreach ($actall_code as $ACTIVITY) {
		...
		if($data['required']=='All' || $data['required']=="" || $data['required']=="STAGE_150_160"){
				while($prow = sqlsrv_fetch_array($stmt)){	
					...
					$activity = $prow['ACTIVITYTYPE'];
					if(isset($prow['STAGE_120_130'])){
					$acevtcount= $prow['STAGE_150_160'];
					$allactivitycountarr['STAGE_150_160'][] =  array("name"=>$activity,"y"=>$acevtcount,"tname"=>$activity,'NID'=>$activity,"act"=>"STAGE_150_160");
						if(!in_array($activity, $actidarr)){
							$actidarr[] = $activity;
						}
					}
				...
				if($csapp=='no'){
					$allactivitycountarr['STAGE_150_160'][] =  array("name"=>$ACTIVITY,"y"=>0,"tname"=>$ACTIVITY,'NID'=>$ACTIVITY,"act"=>"STAGE_150_160");
				}
				sqlsrv_next_result($stmt);
			}
