...
.topdashboardicon{
  ...
  <ul class="nav navbar-nav" style="margin-left: 10%;">
    <li><a href="PDTrailDashBoard.php" class=" fa fa-cubes" style="color: green;"><span style="color: #424242;">&nbsp;&nbsp;PD Trials</span></a></li>
...
margin-right: -40px;"> --></a> </header>
    ...
    <div class="menu">
      <ul id="menu" >
        <li id="menu-home" class="<?=@($cpage=='PDTrailDashBoard')?'active':''?>"><a href="PDTrailDashBoard.php"><i class="fa fa-home"></i><span>Observation</span></a></li>
      </ul>
    </div>
  </div>
    ...
    margin-top: -2px;" >
      ...
      <div class="brand-logo">
	    <a href="../pages/landing.php">
                <img src="../global/photos/logo.png" alt="logo" style="height: 45px !important;padding-left: 16px;margin-top: -2px;"></a>
    <button type="button" class="navbar-toggler collapsed" data-target="#site-navbar-search"
        data-toggle="collapse">
        <span class="sr-only">Toggle Search</span>
        <i class="icon md-search" aria-hidden="true"></i>
    ...
    <div class="navbar-container container-fluid">
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
		...
		<li class="nav-item hidden-float">
            <a class="nav-link" role="button">PD Trials</a>
          </li>
       ...
       <div class="col-xxl-4 col-lg-3 col-sm-12" style="max-width: 24%">
          ...
          <div class="panel panel-bordered" style="height:106px;padding-top: 1px;margin: 0 -10px;">
            <div class="panel-body" style="margin-top: -26px">
               <div class="row">
                  <?php  if($cpage=='PDTrailDashBoard'){ ?>
                 <label class="form-control-label" style="padding-left: 2px;">Season</label>
                
              <select class="form-control form-control-sm season" name="season" style="margin-left: 31%;margin-top: -6%;">
                <option value="<?=@date("y")?>">KH-<?=@date("Y")?></option>
                <
              </select>
                           ...
                           <?php
                              $sql =" SELECT * FROM  ".$hybridtbl." ";
                                ...
                                while($row = sqlsrv_fetch_array($res)){       
                                  ?>
                                   <option value="<?=@trim(utf8_encode($row['HYBRID']))?>"><?=@$row['HYBRID']?></option>
                                   <?php
                                }
                           ?>
                         </select>
