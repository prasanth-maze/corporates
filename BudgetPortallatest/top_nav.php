              ...
              <!-- Department -->
               <div style="padding-top: 12px;">
                ...
                <?php
                  ...
                  $sql ="SELECT BusinessDivision FROM  ".$costcentrelmtbl." GROUP BY BusinessDivision ORDER BY BusinessDivision ASC ";
                  $res = sqlsrv_query($conn,$sql,array(), array( "Scrollable" => 'static' ));
            ...
            <div class="panel-body">
              <div class="row"> 
                 <div class="form-group form-material col-md-3 col-sm-12" style="margin-top: 22px;margin-left: -1%;padding-left: 1px;">
                  ...
                  $sql ="SELECT DepartmentName FROM  ".$costcentrelmtbl." WHERE BusinessDivision IN('".$ImpldFltrBnsnDvsnArr."')  GROUP BY DepartmentName ORDER BY DepartmentName ASC";
                  $res = sqlsrv_query($conn,$sql,array(), array( "Scrollable" => 'static' ));
                  while($row = sqlsrv_fetch_array($res)){ 
                ...
                <?php
                  ...
                  <?php
                    $impldFiltrDepArr = implode("','", $FiltrDepArr);
                  $sql ="SELECT Division FROM  ".$costcentrelmtbl." WHERE BusinessDivision IN('".$ImpldFltrBnsnDvsnArr."') AND DepartmentName IN ('".$impldFiltrDepArr."') GROUP BY Division ORDER BY Division ASC";
                  $res = sqlsrv_query($conn,$sql,array(), array( "Scrollable" => 'static' ));
                  $Divisionarr = array();
                  while($row = sqlsrv_fetch_array($res)){ 
                            $Divisionarr[] = @utf8_encode(trim($row['Division']));
                        ?>
                  ...
                  <div class="form-group form-material col-md-3 col-sm-12" style="margin-top: 3px;margin-left: 1%;padding-left: 1px;">
                     ...
                     <select id="region" name="region[]" class="MulSel regionSelect" multiple="multiple">
                      <?php
                      $impldDivisionarr = implode("','", $Divisionarr);
                      $sql ="SELECT Region FROM  ".$costcentrelmtbl." WHERE BusinessDivision IN('".$ImpldFltrBnsnDvsnArr."') AND DepartmentName IN ('".$impldFiltrDepArr."') AND Division IN ('".$impldDivisionarr."')  GROUP BY Region ORDER BY Region ASC";
                      $res = sqlsrv_query($conn,$sql,array(), array( "Scrollable" => 'static' ));
                      $regionarr = array();
                          while($row = sqlsrv_fetch_array($res)){ 
                            $regionarr[] = @utf8_encode(trim($row['Region']));
                        ?>
                  ...
                  <?php } ?>
                    <?php
                       ...
                       <div class="form-group form-material col-md-3 col-sm-12" style="margin-top: 22px;margin-left: -2%;">
                        ...
                        <?php
                        $impldregionarr = implode("','", $regionarr);
                        $sql ="SELECT Territory FROM  ".$costcentrelmtbl." WHERE BusinessDivision IN('".$ImpldFltrBnsnDvsnArr."') AND DepartmentName IN ('".$impldFiltrDepArr."') AND Division IN ('".$impldDivisionarr."') AND Region IN('".$impldregionarr."')  GROUP BY Territory ";
                        $res = sqlsrv_query($conn,$sql,array(), array( "Scrollable" => 'static' ));
                        $terriotryarr = array();
                        while($row = sqlsrv_fetch_array($res)){ 
                          $terriotryarr[] = $row['Territory'];
                        ?>
  ...
  <div class="col-xxl-4 col-lg-4 col-sm-12" style="margin-left: 88px;max-width: 21%;">
            ...
            <div class="form-group form-material col-md-4 col-sm-12" style="padding-left: 0px;margin-left: 4px;margin-top: 2px;">
                       ...
                       <select id="expgroup" name="expgroup[]" class="MulSel expgroupSelect" multiple="multiple">
                          ...
                          $sql = "SELECT CostElementGroup FROM ".$costcentrelmtbl." GROUP BY CostElementGroup ORDER BY CostElementGroup ASC";
                          $res = sqlsrv_query($conn,$sql,array(), array( "Scrollable" => 'static' ));
                          while($row = sqlsrv_fetch_array($res)){ 
                  ...
                  <?php
                  $sql ="SELECT CostElementName FROM ".$costcentrelmtbl." GROUP BY CostElementName ORDER BY CostElementName ASC";
                  //echo $sql;exit;
                  $res = sqlsrv_query($conn,$sql,array(), array( "Scrollable" => 'static' ));  while($row = sqlsrv_fetch_array($res)){ 
                      $cename = trim($row['CostElementName']);
                          ?>
                      <option selected="selected" value="<?=@$cename?>"><?=@$cename?></option>
                      <?php
                      }
                  ?>
                  </select>
