		    ...
		    // echo $cegroup."<br>";
				...
				foreach ($month_range as $my) {
					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						$VarianceTotal[]=$variance;
						$VariancePTotal[]=$variancep;
						$ReviewModal = '<div><button class="btn" style="color:white;background-color:#02cf92" data-toggle="modal" data-target="#ReviewCommentCE'.$rowno.''.$CmntNUm.'">Comment</button><div class="modal fade" id="ReviewCommentCE'.$rowno.''.$CmntNUm.'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" style="background-color:#02cf92"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title" style="color:white;background-color:#02cf92">Comment Section</h4></div><div class="modal-body"><p><b>Enter Your Comment In Below Input</b></p><textarea class="ReviewCommentCE'.$rowno.''.$CmntNUm.' form-control" rows="5" name=""></textarea></div><div class="modal-footer" style="background-color:#02cf92"><button type="button" class="RevCommentReset btn btn-default" onclick="ReviemRemarkReset(this)">Reset</button><button type="button" class="RevCommentSave btn btn-default" onclick="ReviemRemarkSave(this)">Save</button><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
						$monthwisebudget_data .="<td class='plan' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetPlan'])."</td><td class='actual' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetActual'])."</td><td class='var' style='background-color:".$bgclrr."'>".moneyFormatIndia($variance)."</td><td class='varp' style='background-color:".$bgclrr."'>".$variancep."</td><td class='ReviewRemark' style='background-color:".$bgclrr."'>".$ReviewModal."</td>";	
					}
					$bgnum++;
					$CmntNUm++;
		       ...
		       $CmntNUm = 1;
				foreach ($month_range as $my) {
					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						$VarianceTotal[]=$variance;
						$VariancePTotal[]=$variancep;
						$ReviewModal = '<div><button class="btn" style="color:white;background-color:#02cf92" data-toggle="modal" data-target="#ReviewCommentBD'.$rowno.''.$CmntNUm.'">Comment</button><div class="modal fade" id="ReviewCommentBD'.$rowno.''.$CmntNUm.'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" style="background-color:#02cf92"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title" style="color:white;background-color:#02cf92">Comment Section</h4></div><div class="modal-body"><p><b>Enter Your Comment In Below Input</b></p><textarea class="ReviewCommentBD'.$rowno.''.$CmntNUm.' form-control" rows="5" name=""></textarea></div><div class="modal-footer" style="background-color:#02cf92"><button type="button" class="RevCommentReset btn btn-default" onclick="ReviemRemarkReset(this)">Reset</button><button type="button" class="RevCommentSave btn btn-default" onclick="ReviemRemarkSave(this)">Save</button><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
						$monthwisebudget_data .="<td class='plan' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetPlan'])."</td><td class='actual' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetActual'])."</td><td class='var' style='background-color:".$bgclrr."'>".moneyFormatIndia($variance)."</td><td class='varp' style='background-color:".$bgclrr."'>".$variancep."</td><td class='ReviewRemark' style='background-color:".$bgclrr."'>".$ReviewModal."</td>";	
					}
					$bgnum++;
					$CmntNUm++;
		...
		foreach ($dept as $key => $deptval) {
			...
			foreach ($month_range as $my) {
					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						$VarianceTotal[]=$variance;
						$VariancePTotal[]=$variancep;
						$ReviewModal = '<div><button class="btn" style="color:white;background-color:#02cf92" data-toggle="modal" data-target="#ReviewCommentDep'.$rowno.''.$CmntNUm.'">Comment</button><div class="modal fade" id="ReviewCommentDep'.$rowno.''.$CmntNUm.'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" style="background-color:#02cf92"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title" style="color:white;background-color:#02cf92">Comment Section</h4></div><div class="modal-body"><p><b>Enter Your Comment In Below Input</b></p><textarea class="ReviewCommentDep'.$rowno.''.$CmntNUm.' form-control" rows="5" name=""></textarea></div><div class="modal-footer" style="background-color:#02cf92"><button type="button" class="RevCommentReset btn btn-default" onclick="ReviemRemarkReset(this)">Reset</button><button type="button" class="RevCommentSave btn btn-default" onclick="ReviemRemarkSave(this)">Save</button><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
						//For  Monthwise Column Total
						$monthwisebudget_data .="<td class='plan' style='background-color:".$bgclrr."' >".moneyFormatIndia($row2['BudgetPlan'])."</td><td class='actual' style='background-color:".$bgclrr."' >".moneyFormatIndia($row2['BudgetActual'])."</td><td class='var' style='background-color:".$bgclrr."'>".moneyFormatIndia($variance)."</td><td class='varp' style='background-color:".$bgclrr."' >".$variancep."</td><td class='ReviewRemark' style='background-color:".$bgclrr."'>".$ReviewModal."</td>";	
					}
					$bgnum++;
		    ...
		    // echo $cegroup."<br>";
				...
				foreach ($month_range as $my) {
					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						$VarianceTotal[]=$variance;
						$VariancePTotal[]=$variancep;
						$ReviewModal = '<div><button class="btn" style="color:white;background-color:#02cf92" data-toggle="modal" data-target="#ReviewCommentDv'.$rowno.''.$CmntNUm.'">Comment</button><div class="modal fade" id="ReviewCommentDv'.$rowno.''.$CmntNUm.'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" style="background-color:#02cf92"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title" style="color:white;background-color:#02cf92">Comment Section</h4></div><div class="modal-body"><p><b>Enter Your Comment In Below Input</b></p><textarea class="ReviewCommentDv'.$rowno.''.$CmntNUm.' form-control"  rows="5" name=""></textarea></div><div class="modal-footer" style="background-color:#02cf92"><button type="button" class="RevCommentReset btn btn-default" onclick="ReviemRemarkReset(this)">Reset</button><button type="button" class="RevCommentSave btn btn-default" onclick="ReviemRemarkSave(this)">Save</button><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
						$monthwisebudget_data .="<td class='plan' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetPlan'])."</td><td class='actual' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetActual'])."</td><td class='var' style='background-color:".$bgclrr."'>".moneyFormatIndia($variance)."</td><td class='varp' style='background-color:".$bgclrr."'>".$variancep."</td><td class='ReviewRemark' style='background-color:".$bgclrr."'>".$ReviewModal."</td>";	
					// }
					}
					$bgnum++;
		    ...
		    // echo $cegroup."<br>";
				...
				foreach ($month_range as $my) {
					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						$VarianceTotal[]=$variance;
						$VariancePTotal[]=$variancep;
						$ReviewModal = '<div><button class="btn" style="color:white;background-color:#02cf92" data-toggle="modal" data-target="#ReviewCommentRgn'.$rowno.''.$CmntNUm.'">Comment</button><div class="modal fade" id="ReviewCommentRgn'.$rowno.''.$CmntNUm.'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" style="background-color:#02cf92"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title" style="color:white;background-color:#02cf92">Comment Section</h4></div><div class="modal-body"><p><b>Enter Your Comment In Below Input</b></p><textarea class="ReviewCommentRgn'.$rowno.''.$CmntNUm.' form-control" rows="5" name=""></textarea></div><div class="modal-footer" style="background-color:#02cf92"><button type="button" class="RevCommentReset btn btn-default" onclick="ReviemRemarkReset(this)">Reset</button><button type="button" class="RevCommentSave btn btn-default" onclick="ReviemRemarkSave(this)">Save</button><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
						$monthwisebudget_data .="<td class='plan' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetPlan'])."</td><td class='actual' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetActual'])."</td><td class='var' style='background-color:".$bgclrr."'>".moneyFormatIndia($variance)."</td><td class='varp' style='background-color:".$bgclrr."'>".$variancep."</td><td class='ReviewRemark' style='background-color:".$bgclrr."'>".$ReviewModal."</td>";	
					}
					$bgnum++;
					$CmntNUm++;
		    ...
		    // echo $cegroup."<br>";
				...
				foreach ($month_range as $my) {
					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						$VarianceTotal[]=$variance;
						$VariancePTotal[]=$variancep;
						$ReviewModal = '<div><button class="btn" style="color:white;background-color:#02cf92" data-toggle="modal" data-target="#ReviewCommentTer'.$rowno.''.$CmntNUm.'">Comment</button><div class="modal fade" id="ReviewCommentTer'.$rowno.''.$CmntNUm.'" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header" style="background-color:#02cf92"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title" style="color:white;background-color:#02cf92">Comment Section</h4></div><div class="modal-body"><p><b>Enter Your Comment In Below Input</b></p><textarea class="form-control ReviewCommentTer'.$rowno.''.$CmntNUm.'" rows="5" name=""></textarea></div><div class="modal-footer" style="background-color:#02cf92"><button type="button" class="RevCommentReset btn btn-default" onclick="ReviemRemarkReset(this)">Reset</button><button type="button" class="RevCommentSave btn btn-default" onclick="ReviemRemarkSave(this)">Save</button><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div></div></div>';
						$monthwisebudget_data .="<td class='plan' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetPlan'])."</td><td class='actual' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetActual'])."</td><td class='var' style='background-color:".$bgclrr."'>".moneyFormatIndia($variance)."</td><td class='varp' style='background-color:".$bgclrr."'>".$variancep."</td><td class='ReviewRemark' style='background-color:".$bgclrr."'>".$ReviewModal."</td>";	
					}
					$bgnum++;
					$CmntNUm++;
