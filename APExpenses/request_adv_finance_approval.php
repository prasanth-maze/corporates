...
if(isset($_REQUEST['submit'])){
  ...
  $approved_amt      = $_REQUEST['approved_amt'];
  ...
  $approve_remark  = $_REQUEST['approve_remark']; 
    ...
    for($i=0,$j=0;$i<sizeof($adv_amt_id);$i++,$j++){
         $inserta = sqlsrv_query($conn,"UPDATE ANP_Advance_Amount SET FinanceApprovedAmount='$approve_amt[$i]',FinanceApprovedRemark='$approve_remark[$i]',FinanceApprovedBy='$approved_by',FinanceApprovedAt='$approved_at' WHERE Id = '$adv_amt_id[$i]'" ); 
      }
    if(sizeof($adv_amt_id) == $j){
      ...
      $subject  ="INR ".$tot_appr_amt." Approved By $approved_by";
          $message 	="<div>
                        ...
                        Requested By : $adv_to <br/>
                        Division : $div_name <br/>
                        Region :  $reg_name <br/>
                        Territory :  $teri_name <br/>
                      </div>
                      <table border='1'>
                        <tr>
                          <th>Sno</th>
                        ...
                        for($i=0,$j=1;$i<sizeof($adv_amt_id);$i++,$j++){
                          $message.= "<tr>
                                          ...
                                          <td>$subact_name[$i]</td>
                                          <td>$advreq_name[$i]</td>
                                          <td>$approved_amt[$i]</td>
                                          <td>$approve_amt[$i]</td>
                                        </tr>";
                          }
                          $reqest = array_sum($approve_amt);
                          $apprd = array_sum($approved_amt);
                          $message.= "<tr>
          ...
          if($mail->Send()){
            /* echo "<script type='text/javascript'>alert('Finance Approved SuccessFully.')</script>";
            echo '<script type="text/javascript">
                    window.location.replace("advance_payment_view.php");
                </script>'; */
                echo "<script>window.location='request_adv_finance_approval.php?request_id=".$request_id."'</script>";
          ...
          <div class="fullscreen-container">
            <div id="popdiv">
              ...
              <h3>  
                  ...
                  Advance Request has been Approved.</br>
              </h3>
            ...
            <script>
                $( document ).ready(function() {
                  ...
                  $("#but2").click(function() {
                    window.location='advance_payment_view.php';
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                <div class="col-md-4 col-sm-12 col-xs-12">
                  ...
                  <div class="row">
                    <label class="control-label col-md-3 col-sm-4 col-xs-12" for="name">Advance To</label>
                      <div class="col-md-9 col-sm-8 col-xs-12 ">
                      <input type="text" class="form-control col-md-12 col-xs-12 required_for_valid" name="adv_to" value="<?php echo $fetch_adv_det['AdvanceTo'];?>" readonly>
                      </div>
                  </div>
                  </div>
                </div>
                ...
                <table class="table">
                  ...
                  <tbody>                    
                    <?php   $i = $tot_adv_amt = $tot_app_amt = 0;
                      ...
                      ANP_Advance_Amount.SubActivityId, APSUBACTIVITYMASTER.SUBACTIVITY, ANP_Advance_Amount.AdvAmount, ANP_Advance_Amount.ApprovedAmount 
                      ...
                      while($fetch_activity_det = sqlsrv_fetch_array($view_activity)){
                        ?>
                        <input type="hidden" name="crop_name[]" value="<?php echo $fetch_activity_det['CropId'] ;?>">
                        <input type="hidden" name="act_name[]" value="<?php echo $fetch_activity_det['ACTIVITYTYPE'] ;?>">
                        ...
                        <input type="hidden" name="approved_amt[]" value="<?php echo $fetch_activity_det['ApprovedAmount'] ;?>">
                        <tr>
                            <td><?php echo ++$i;?></td>
                            ...
                            <td class ="max_amount"  align="right"><?php  $tot_app_amt =  $tot_app_amt + $fetch_activity_det['ApprovedAmount']; echo $fetch_activity_det['ApprovedAmount'];?></td>
                            <td ><div ><input type="text"  class="form-control right only_numbers required_for_valid entering_amt" max="500" name="approve_amt[]" value="<?php echo $fetch_activity_det['ApprovedAmount'];?>"></div></td>
                            <td>
                ...
                <div class="col-xs-12" style="float: right;">
                    <a href="advance_finance_approve_view.php" class="btn btn-danger">Cancel</a>
