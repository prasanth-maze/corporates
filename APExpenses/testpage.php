          ...
          <div class="tab-content pt-20">
             <div class="tab-pane restabpanel active" id="DivisionRes"  role="tabpanel">
                <table class="table table-hover dataTable table-striped w-full example" border="0" id="DivisionRestbl" data-loaded='no'>
                    ...
                    <?php 
                    $i =0;
                    $viw_adv =sqlsrv_query($conn,"spABC");  
                    ...
                    ?>
                      <tr>
                        ...
                        <td align="right"><?php echo $rows['ApprovedAmt'] - $rows['PaidAmt']; ?></td>
                        <td align="right"><?php echo $rows['VerifiedAmount']; ?></td>
                        <td>
                        <?php if($rows['ApprovedAmt'] > $rows['PaidAmt']){ ?> 
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Advance Request Details</h4>
                    </div>
 ...
 $(document).on("click", ".edit_btn", function ()
    {
        ...
        var permanent_id = $tr.find(".permanent_id").val();
        $.ajax({
            type: "POST",
            url: "ajax_popup_details.php",
            data: {
                permanent_id: permanent_id,
				        action_type:"ADV_REQUEST_PAYMENT_SPLITUP_DETAILS"
            },
            success: function (output) {
                $(".modal_fade_content").html(output);
