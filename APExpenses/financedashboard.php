    ...
    <div class="page-content container-fluid ">
      <div class="panel panel-bordered"></div>
            ...
            <div class="container">
                        ...
                        <div class="card card4">
                          <div class="media">
                            ...
                            <div class="media-body">
                              <h4><b>No. <?php echo 0; ?> </b> Waiting for <br/><span>verification & payment - Rs. <?php echo 90; ?> /-</span></h4>
                            </div>
                            </div>
               ...
               <div class="dash_url">
                    <!-- <a href="advance_finance_approve_view.php"> Pending Advance Requests</a> -->
                    <a href="advance_payment_view.php">Advance Payments</a>
                </div>
                </br>
                </div>
            </div>
