             ...
             <div class="tab-pane restabpanel active" id="DivisionRes"  role="tabpanel">
                <table class="table table-hover dataTable table-striped w-full example" border="0" id="DivisionRestbl" data-loaded='no'>
                    ...
                    $viw_adv =sqlsrv_query($conn,"SELECT 
                            ...
                            SUM(ANP_Advance_Amount.FinanceApprovedAmount) as 'FinanceApprovedAmt' ,
                    ...
                    while($rows = sqlsrv_fetch_array($viw_adv)){ 
                      if($rows['ApprovedAmt'] == null){
                        continue;
                      }if($rows['FinanceApprovedAmt'] != null){
                        continue;
                      }
                    ?>
                      <tr>
                        ...
                        <td align="right"><?php echo $rows['FinanceApprovedAmt']; ?></td>
                        <td align="right"><?php echo $rows['PaidAmt']; ?></td>
                        <!-- <td>0</td>
                        <td>0</td> -->
                        <td>
                          <a href="request_adv_finance_approval.php?Advid=<?php echo $rows['AdvId']; ?>">&nbsp;Verify&nbsp;</a>
                        </td>
                      </tr>
                    <?php  } ?>
                    </tbody>
