		    ...
		    // echo $cegroup."<br>";
				...
				foreach ($month_range as $my) {
					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						$ReviewModal = '<input class="form-control" id="ReviewCommentCG'.$rowno.''.$CmntNUm.'">';
		    ...
		    // echo $cegroup."<br>";
				...
				foreach ($month_range as $my) {
					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						$VarianceTotal[]=$variance;
						$VariancePTotal[]=$variancep;
						$ReviewModal = '<input class="form-control" id="ReviewCommentCE'.$rowno.''.$CmntNUm.'">';
						$monthwisebudget_data .="<td class='plan' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetPlan'])."</td><td class='actual' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetActual'])."</td><td class='var' style='background-color:".$bgclrr."'>".moneyFormatIndia($variance)."</td><td class='varp' style='background-color:".$bgclrr."'>".$variancep."</td><td class='ReviewRemark' style='background-color:".$bgclrr."'>".$ReviewModal."</td>";	
					}
					$bgnum++;
					$CmntNUm++;
		       ...
		       $CmntNUm = 1;
				foreach ($month_range as $my) {
					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						$VarianceTotal[]=$variance;
						$VariancePTotal[]=$variancep;
						$ReviewModal = '<input class="form-control" id="ReviewCommentBD'.$rowno.''.$CmntNUm.'">';
						$monthwisebudget_data .="<td class='plan' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetPlan'])."</td><td class='actual' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetActual'])."</td><td class='var' style='background-color:".$bgclrr."'>".moneyFormatIndia($variance)."</td><td class='varp' style='background-color:".$bgclrr."'>".$variancep."</td><td class='ReviewRemark' style='background-color:".$bgclrr."'>".$ReviewModal."</td>";	
					}
					$bgnum++;
					$CmntNUm++;
		...
		foreach ($dept as $key => $deptval) {
			...
			foreach ($month_range as $my) {
					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						$VarianceTotal[]=$variance;
						$VariancePTotal[]=$variancep;
						$ReviewModal = '<input class="form-control" id="ReviewCommentDep'.$rowno.''.$CmntNUm.'">';
						//For  Monthwise Column Total
						$monthwisebudget_data .="<td class='plan' style='background-color:".$bgclrr."' >".moneyFormatIndia($row2['BudgetPlan'])."</td><td class='actual' style='background-color:".$bgclrr."' >".moneyFormatIndia($row2['BudgetActual'])."</td><td class='var' style='background-color:".$bgclrr."'>".moneyFormatIndia($variance)."</td><td class='varp' style='background-color:".$bgclrr."' >".$variancep."</td><td class='ReviewRemark' style='background-color:".$bgclrr."'>".$ReviewModal."</td>";	
					}
					$bgnum++;
		    ...
		    // echo $cegroup."<br>";
				...
				foreach ($month_range as $my) {
					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						$VarianceTotal[]=$variance;
						$VariancePTotal[]=$variancep;
						$ReviewModal = '<input class="form-control" id="ReviewCommentDv'.$rowno.''.$CmntNUm.'">';
						$monthwisebudget_data .="<td class='plan' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetPlan'])."</td><td class='actual' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetActual'])."</td><td class='var' style='background-color:".$bgclrr."'>".moneyFormatIndia($variance)."</td><td class='varp' style='background-color:".$bgclrr."'>".$variancep."</td><td class='ReviewRemark' style='background-color:".$bgclrr."'>".$ReviewModal."</td>";	
					// }
					}
					$bgnum++;
		    ...
		    // echo $cegroup."<br>";
				...
				foreach ($month_range as $my) {
					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						$VarianceTotal[]=$variance;
						$VariancePTotal[]=$variancep;
						$ReviewModal = '<input class="form-control" id="ReviewCommentRgn'.$rowno.''.$CmntNUm.'">';
						$monthwisebudget_data .="<td class='plan' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetPlan'])."</td><td class='actual' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetActual'])."</td><td class='var' style='background-color:".$bgclrr."'>".moneyFormatIndia($variance)."</td><td class='varp' style='background-color:".$bgclrr."'>".$variancep."</td><td class='ReviewRemark' style='background-color:".$bgclrr."'>".$ReviewModal."</td>";	
					}
					$bgnum++;
					$CmntNUm++;
		    ...
		    // echo $cegroup."<br>";
				...
				foreach ($month_range as $my) {
					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						$VarianceTotal[]=$variance;
						$VariancePTotal[]=$variancep;
						$ReviewModal = '<input class="form-control" id="ReviewCommentTer'.$rowno.''.$CmntNUm.'">';
						$monthwisebudget_data .="<td class='plan' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetPlan'])."</td><td class='actual' style='background-color:".$bgclrr."'>".moneyFormatIndia($row2['BudgetActual'])."</td><td class='var' style='background-color:".$bgclrr."'>".moneyFormatIndia($variance)."</td><td class='varp' style='background-color:".$bgclrr."'>".$variancep."</td><td class='ReviewRemark' style='background-color:".$bgclrr."'>".$ReviewModal."</td>";	
					}
					$bgnum++;
					$CmntNUm++;
