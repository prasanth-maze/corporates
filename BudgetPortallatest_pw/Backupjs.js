...
var AllColumnClass = ["ElemGrouprow","costElementrow","BusinessDivrow","Departmentrow","Divisionrow","Regionrow","Territoryrow"]
	 ...
	 // Tooltip
	 function VarianceTooltip(ColVal){
	 	if(ColVal == "Eg"){
			$('.var').mouseover(function(event) { 
				// alert();
		        $('#BudgetRemarkdiv').show();
		        $('#BudgetRemarkdiv').html();
		        $('#BudgetRemarkdiv').html($(this).parent().children().first().text());
			...
			$('.var').mouseover(function(event) { 
		        ...
		        $('#BudgetRemarkdiv').show();
		        $('#BudgetRemarkdiv').html();
		        $('#BudgetRemarkdiv').html($(this).parent().children().first().next().text());
		        $('#BudgetRemarkdiv').css('top', event.pageY-50);
				$('#BudgetRemarkdiv').css('left', event.pageX-(-30));
		    });
		    $('.var').mouseout(function() {
			...
			$('.var').mouseover(function(event) { 
		        ...
		        $('#BudgetRemarkdiv').show();
		        $('#BudgetRemarkdiv').html();
		        $('#BudgetRemarkdiv').html($(this).parent().children().first().next().next().text());
		        $('#BudgetRemarkdiv').css('top', event.pageY-50);
				$('#BudgetRemarkdiv').css('left', event.pageX-(-30));
		    });
		    $('.var').mouseout(function() {
			...
			$('.var').mouseover(function(event) { 
		        ...
		        $('#BudgetRemarkdiv').show();
		        $('#BudgetRemarkdiv').html();
		        $('#BudgetRemarkdiv').html($(this).parent().children().first().next().next().next().text());
		        $('#BudgetRemarkdiv').css('top', event.pageY-50);
				$('#BudgetRemarkdiv').css('left', event.pageX-(-30));
		    });
		    $('.var').mouseout(function() {
			...
			$('.var').mouseover(function(event) { 
		        ...
		        $('#BudgetRemarkdiv').show();
		        $('#BudgetRemarkdiv').html();
		        $('#BudgetRemarkdiv').html($(this).parent().children().first().next().next().next().next().text());
		        $('#BudgetRemarkdiv').css('top', event.pageY-50);
				$('#BudgetRemarkdiv').css('left', event.pageX-(-30));
		    });
		    $('.var').mouseout(function() {
			...
			$('.var').mouseover(function(event) { 
		        ...
		        $('#BudgetRemarkdiv').show();
		        $('#BudgetRemarkdiv').html();
		        $('#BudgetRemarkdiv').html($(this).parent().children().first().next().next().next().next().next().text());
		        $('#BudgetRemarkdiv').css('top', event.pageY-50);
				$('#BudgetRemarkdiv').css('left', event.pageX-(-30));
		    });
		    $('.var').mouseout(function() {
			...
			$('.var').mouseover(function(event) { 
		        ...
		        $('#BudgetRemarkdiv').show();
		        $('#BudgetRemarkdiv').html();
		        $('#BudgetRemarkdiv').html($(this).parent().children().first().next().next().next().next().next().next().text());
		        $('#BudgetRemarkdiv').css('top', event.pageY-50);
				$('#BudgetRemarkdiv').css('left', event.pageX-(-30));
		    });
		    $('.var').mouseout(function() {
