 ...
 //   p($_POST,'e');
    ...
    $costcntrs =array();
      ...
      $sql = "SELECT CostCenterCode FROM ".$costcentrelmtbl." ";
      ...
      if(isset($_POST['terriotry'])){
	   ...
	   /* $expgroup = implode("','",$_POST['expgroup']);
        $cond .= " ".$addand." CostElementGroup IN('".$expgroup."')";
        $addand = " AND ";
		
		$costElement = implode("','",$_POST['costElement']);
        $cond .= " ".$addand." CostElementName IN('".$costElement."')";*/
