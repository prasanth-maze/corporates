					...
					while($row2= sqlsrv_fetch_array($res2)){ 
						...
						// For Monthwisecolor  background-color:#e6eeff
						 ...
						 if ($bgnum % 2 == 0) {
							...
							//echo $variance.' '.$row2['BudgetPlan'].' '.($variance/$row2['BudgetPlan']);exit;
